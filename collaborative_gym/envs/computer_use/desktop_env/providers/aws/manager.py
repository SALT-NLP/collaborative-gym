...
from collaborative_gym.envs.computer_use.desktop_env.providers.base import VMManager

# Import proxy-related modules only when needed
try:
    from collaborative_gym.envs.computer_use.desktop_env.providers.aws.proxy_pool import get_global_proxy_pool, init_proxy_pool
...
def _allocate_vm_with_proxy(region=DEFAULT_REGION, proxy_config_file=None):
    ...
    from collaborative_gym.envs.computer_use.desktop_env.providers.aws.provider_with_proxy import AWSProviderWithProxy
